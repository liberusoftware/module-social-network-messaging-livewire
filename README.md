...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-messaging-livewire?sort=semver)](https://github.com/liberusoftware/module-social-network-messaging-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-messaging-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-messaging-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-messaging-livewire
```
...
<a href="https://github.com/liberusoftware/module-social-network-messaging-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-messaging-livewire" alt="Contributors to liberusoftware/module-social-network-messaging-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-messaging-livewire/graphs/contributors).
